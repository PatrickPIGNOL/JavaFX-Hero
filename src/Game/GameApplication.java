...
public class GameApplication extends Application
{
	...
	public void mLoad()
	{
	    this.aStage.setTitle("JavaFX : Hero");	
	    int[][] vTilesArray = 
    	{
	    ...
	    List<List<Integer>> vLayer = new ArrayList<List<Integer>>();
	    for(int[] vLayerLine : vLayerArray)
	    {
	    	List<Integer> vLine = new ArrayList<Integer>();
	    	for(int vTile : vLayerLine)
	    	{
	    		vLine.add(vTile);
	    	}
	    	vLayer.add(vLine);
	    ...
	    this.aGame = new Game(vTiles, vLayer);
	    this.mStart();
	}
	...
	{
		this.aGame.mKeyPress(e);
	}
	
	private void mOnKeyReleased(KeyEvent e)
	{
		this.aGame.mKeyRelease(e);
	}
